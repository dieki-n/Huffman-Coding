Implementation of [Huffman compression](https://en.wikipedia.org/wiki/Huffman_coding) in C++. Gets about 1.75:1 compression ratio on english text.
...
Compression results on shakespeare.txt:
